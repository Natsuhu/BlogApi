...
CREATE TABLE `comment`  (
  ...
  `object_type` int NOT NULL COMMENT '1文章2友链3关于我6动态',
  `reply_nickname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '回复的人昵称',
  `object_id` bigint NULL DEFAULT NULL COMMENT '评论的文章ID或动态ID',
  `tree_id` varchar(32) NULL DEFAULT NULL COMMENT '归属ID',
